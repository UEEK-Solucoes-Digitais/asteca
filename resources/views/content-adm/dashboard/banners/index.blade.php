...
@section('content')
    @php $instance_name = "banner" @endphp
    @csrf
    <div class="default-space-between">
        ...
        <div class="d-flex">
            <a class="btn-geral btn-green" href="{{ route('banner.add') }}">
                        ...
                        <tr id="item-{{ $banner->id }}">
                            ...
                            <td>
                                <div class='d-flex'>
                                    ...
                                    <button class='btn-red btn-action remove-item' data-value='{{ $banner->id }}'
    ...
    <script>
        var url_organize = "{{ route('banner.organize') }}";
        var url_delete = "{{ route('banner.delete') }}";
        var url_delete_multiple = "{{ route('banner.delete_multiple') }}";
        var url_to_redirect = "{{ route('banner.list') }}"
        var url_copy = "{{ route('banner.copy') }}"
    </script>
@endsection
